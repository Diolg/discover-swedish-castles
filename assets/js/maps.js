...
//Created an object from parameters
 ...
 //Created map locations array
...

    {
        ...
        info: '<div class="info-window"><img class="info-window-image" src="assets/images/gorvalnslott-castle.jpg" alt="castle"><h6><strong>Gorvalnslott castle</strong></h6><p>Built in 1670s castle is a perfect place for romantic time or for recharging batteries in luxury.</p><p>Here you find: <ul><li>Hotel</li><li>SPA</li><li>Restaurant</li><li>Spaces for walking</li><li>Natural swimming areas</li><li>Fishing areas</li><li>Facilities for winter skiing</li></ul></p></h1><a href="https://www.gorvalnsslott.se/en/" target="_blank">Check full information</a></div>'
    },

    {
        coordinates:{lat: 59.0393, lng: 18.0142},
        info: '<div class="info-window"><img class="info-window-image" src="assets/images/herringe-castle.jpg" alt="castle"><h6><strong>Herringe castle</strong></h6><p>A cosy castle in a 1657 property offering dining & a bowling alley, plus a garden with a pool.</p><p>Here you find: <ul><li>Hotel</li><li>SPA</li><li>Restaurant</li><li>Outside swimming pool</li><li>Spaces for walking</li><li>Natural swimming areas</li><li>Fishing areas</li><li>Riding school</li></ul></p></h1><a href="http://www.haringeslott.se/haringe-slott" target="_blank">Check full information</a></div>'
    }
